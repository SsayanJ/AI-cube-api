...
class SpeedCube():
    def __init__(self):
        ...
        self.solved_cross_new = self.get_yellow_edges_new()
    ...
    def step(self, action):
        ...
        yellow_edges = self.get_yellow_edges_new()
    ...
    def get_yellow_edges(self):
        self.yellow_edges = [e if 5 in e else '' for e in self.get_edges()]
        return self.yellow_edges
    
    def get_yellow_edges_new(self):
